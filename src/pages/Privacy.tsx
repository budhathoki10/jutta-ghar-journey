...
import { businessName, fullAddress, phoneNumber, websiteUrl } from "@/content/site";
    ...
    <div className="mx-auto max-w-5xl">
      ...
      <section className="space-y-10">
        ...
        <article>
          ...
          <p className="mt-4 text-base leading-7 text-muted-foreground">
            If you want your details removed from our booking notes, call {phoneNumber} or email <a href={`mailto:${websiteUrl}`} className="text-primary underline">hello@{websiteUrl.replace("https://", "")}</a>.
          </p>
        </article>
