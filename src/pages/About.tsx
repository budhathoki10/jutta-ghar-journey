...
const About = () => (
  <>
      ...
      <section className="relative mx-auto max-w-7xl px-6 py-24">
        ...
        <ScrollReveal>
          <div className="group rounded-2xl border border-border bg-card p-8 transition-all duration-500 hover:border-primary/50 hover:shadow-lg hover:bg-secondary/60">
            <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-primary/10">
              <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            <h3 className="font-serif text-2xl font-bold mb-3 transition-colors duration-300 group-hover:text-primary">Deep comfort styling</h3>
            <p className="text-muted-foreground mb-6">Personalised shoe fitting and everyday comfort advice, tailored for Kathmandu feet.</p>
            <a href="#" className="text-primary font-medium hover:text-primary/80 transition-colors">Discuss this service →</a>
          </div>
          ...
          <div className="group rounded-2xl border border-border bg-card p-8 transition-all duration-500 hover:border-primary/50 hover:shadow-lg hover:bg-secondary/60">
            ...
            <h3 className="font-serif text-2xl font-bold mb-3 transition-colors duration-300 group-hover:text-primary">Repair & care</h3>
            <p className="text-muted-foreground mb-6">Fast repair, polishing and fitting adjustments for shoes that you wear again and again.</p>
            <a href="#" className="text-primary font-medium hover:text-primary/80 transition-colors">Discuss this service →</a>
          </div>
          ...
          <div className="group rounded-2xl border border-border bg-card p-8 transition-all duration-500 hover:border-primary/50 hover:shadow-lg hover:bg-secondary/60">
            ...
            <h3 className="font-serif text-2xl font-bold mb-3 transition-colors duration-300 group-hover:text-primary">Curated collections</h3>
            <p className="text-muted-foreground mb-6">Branded releases, seasonal drops and local favourites arranged for easy browsing.</p>
            <a href="#" className="text-primary font-medium hover:text-primary/80 transition-colors">Discuss this service →</a>
          </div>
          ...
          <div className="group rounded-2xl border border-border bg-card p-8 transition-all duration-500 hover:border-primary/50 hover:shadow-lg hover:bg-secondary/60">
            ...
            <h3 className="font-serif text-2xl font-bold mb-3 transition-colors duration-300 group-hover:text-primary">Fresh shop displays</h3>
            <p className="text-muted-foreground mb-6">Clean presentation, seasonal looks and polished store styling for a premium visit.</p>
            <a href="#" className="text-primary font-medium hover:text-primary/80 transition-colors">Discuss this service →</a>
          </div>
        </ScrollReveal>
      </section>
