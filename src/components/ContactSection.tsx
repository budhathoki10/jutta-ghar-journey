...
const ContactSection = ({ id }: ContactSectionProps) => (
  <section id={id} className="py-16 md:py-24 px-6 bg-gradient-to-b from-transparent to-primary/5">
    <div className="mx-auto max-w-4xl space-y-12">
      <ScrollReveal>
        <div className="space-y-4">
          <p className="text-sm font-semibold uppercase tracking-widest text-terracotta">§ 05 — सम्पर्क · Contact</p>
          <h2 className="text-5xl font-black leading-tight text-ink">Talk directly with the team.</h2>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          <div className="rounded-xl border border-primary/20 bg-primary/5 p-8">
            <div className="mb-4 flex items-center gap-3">
              ...
              <h3 className="font-bold text-ink">Store Line</h3>
            </div>
            <p className="text-xs uppercase tracking-wider text-foreground/60 mb-2">Immediate orders & enquiries</p>
            <a href="tel:+9779841898731" className="text-lg font-bold text-primary hover:text-primary/80 transition">
              +977 9841 898 731
            </a>
          </div>
          ...
          <div className="rounded-xl border border-terracotta/20 bg-terracotta/5 p-8">
            <div className="mb-4 flex items-center gap-3">
              ...
              <h3 className="font-bold text-ink">Visit</h3>
            </div>
            <p className="text-xs uppercase tracking-wider text-foreground/60 mb-2">Open daily · Walk-ins welcome</p>
            <p className="text-lg font-bold text-foreground">Jagatsundar Marg</p>
            <p className="text-sm text-foreground/60 mt-1">Kathmandu, Nepal</p>
          </div>
        </div>
      </ScrollReveal>
      ...
      <ScrollReveal>
        <div className="rounded-xl border border-border/50 bg-background/50 p-8">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-sm uppercase tracking-[0.3em] text-muted-foreground">Connect on TikTok</p>
              <p className="mt-3 text-sm text-foreground/70">Follow shop updates, new arrivals, and quick style tips from the street.</p>
            </div>
            <a
              href="#"
      ...
      <ScrollReveal>
        <div className="space-y-4 mb-8">
          <h3 className="text-2xl font-black text-ink">Our Team</h3>
        </div>
      </ScrollReveal>
      ...
      <div className="space-y-4">
        {contactPersons.map((person, idx) => (
          <ScrollReveal key={idx} delay={idx * 100}>
            <div className="rounded-xl border border-border/50 bg-background/50 p-6 transition hover:border-primary/50 hover:bg-primary/5">
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  <h4 className="font-bold text-ink mb-1">{person.role}</h4>
                  <p className="text-sm text-foreground/70 mb-3">{person.description}</p>
                  <div className="flex flex-col gap-2">
                    <a href={`tel:${person.phone.replace(/\s/g, '')}`} className="text-sm font-semibold text-primary hover:underline">
                      {person.phone}
                    </a>
      ...
      <ScrollReveal>
        <div className="rounded-xl border border-mustard/20 bg-mustard/5 p-8">
          <h4 className="mb-4 font-bold text-ink">Hours & Location</h4>
      ...
      <ScrollReveal>
        <div className="bg-gradient-to-r from-ink/5 to-terracotta/10 rounded-xl py-12 px-8 text-center">
          <h4 className="text-2xl font-bold text-ink mb-4">Ready to connect?</h4>
          <p className="text-foreground/70 mb-6">Pick your preferred way to reach us — we're here to help.</p>
